...
export class RegisterComponent {
  ...
  isRestaurantNameInvalid() {
    if (this.controls.restaurantName.touched || this.controls.restaurantName.dirty || this.isSubmitted) {
  ...
  isEmailInvalid() {
    if (this.controls.email.touched || this.controls.email.dirty || this.isSubmitted) {
  ...
  isPasswordInvalid() {
    if (this.controls.password.touched || this.controls.password.dirty || this.isSubmitted) {
  ...
  isPassword2Invalid() {
    if (this.controls.password2.touched || this.controls.password2.dirty || this.isSubmitted) {
  ...
  isFirstNameInvalid() {
    if (this.controls.firstName.touched || this.controls.firstName.dirty || this.isSubmitted) {
  ...
  isLastNameInvalid() {
    if (this.controls.lastName.touched || this.controls.lastName.dirty || this.isSubmitted) {
  ...
  isPhoneInvalid() {
    if (this.controls.phone.touched || this.controls.phone.dirty || this.isSubmitted) {
